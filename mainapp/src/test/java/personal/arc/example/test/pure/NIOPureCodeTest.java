package personal.arc.example.test.pure;
 ...
 */
public class NIOPureCodeTest {
    private ByteBuffer readBuffer;
    private Selector selector;

    public static void main(String[] args){
        NIOPureCodeTest nIOPureCodeTest = new NIOPureCodeTest();
        nIOPureCodeTest.init();
        nIOPureCodeTest.listen();
    }
